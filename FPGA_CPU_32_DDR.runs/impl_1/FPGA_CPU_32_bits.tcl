...
OPTRACE "link_design" START { }
  link_design -top FPGA_CPU_32_bits -part xc7a100tcsg324-1 
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force FPGA_CPU_32_bits_opt.dcp
...
OPTRACE "read incremental checkpoint" START { }
  read_checkpoint -auto_incremental  -incremental /home/graham/src/FPGA_CPU_32_DDR/impl_1/FPGA_CPU_32_bits_routed.dcp
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force FPGA_CPU_32_bits_placed.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force FPGA_CPU_32_bits_routed.dcp
...
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force FPGA_CPU_32_bits}
  catch {file copy -force FPGA_CPU_32_bits.ltx debug_nets.ltx}
